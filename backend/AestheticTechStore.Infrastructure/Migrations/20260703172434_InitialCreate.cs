        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MegaCoinBalance = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredWattage = table.Column<int>(type: "integer", nullable: true),
                    WarrantyInfo = table.Column<string>(type: "text", nullable: false),
                    StockStatus = table.Column<string>(type: "text", nullable: false),
                    TechnicalSpecs = table.Column<string>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsInsideDhaka = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MegaCoinTransactions", x => x.Id);
                    table.ForeignKey(
